...
By recoverable, we mean that if one process commited, enough evidence should exist at any subset of n - f processes to be able to adopt safely (n being the process count and f the maximum amount of failures).
